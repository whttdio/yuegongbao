              ...
              <template #label>
                <span>
                  ...
                  <el-tooltip placement="top">
                    <template #content>
                      <div>
                        Bean调用示例：ygbTask.demoParams('demo')
                        <br />Class类调用示例：com.yuegongbao.quartz.task.YgbTask.demoParams('demo')
...
const data = reactive({
  ...
  rules: {
    ...
    cronExpression: [{ required: true, message: "cron 执行表达式不能为空", trigger: "change" }]
  }
})
