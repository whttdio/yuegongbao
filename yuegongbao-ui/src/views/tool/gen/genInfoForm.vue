    ...
    <el-row>
      ...
      <el-col :span="12">
        <el-form-item prop="packageName">
          <template #label>
            生成包路径
            <el-tooltip content="生成在哪个 java 包下，例如 com.yuegongbao.system" placement="top">
      ...
      <el-col :span="12">
        <el-form-item prop="genType">
          ...
          <el-radio v-model="info.genType" value="0">zip 压缩包</el-radio>
      ...
      <el-col :span="24" v-if="info.genType == '1'">
        <el-form-item prop="genPath">
          <template #label>
            自定义路径
            <el-tooltip content="填写磁盘绝对路径，若不填写，则生成到当前 Web 项目下" placement="top">
              <el-icon><question-filled /></el-icon>
            </el-tooltip>
          </template>
