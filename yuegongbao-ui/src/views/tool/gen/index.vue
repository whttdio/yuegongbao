      ...
      <el-table-column label="操作" fixed="right" align="center" width="330" class-name="small-padding fixed-width">
        <template #default="scope">
          <el-tooltip content="预览" placement="top">
            <el-button link type="info" icon="View" @click="handlePreview(scope.row)" v-hasPermi="['tool:gen:preview']"></el-button>
          </el-tooltip>
...
function handleGenTable(row) {
  ...
  if (row.genType === "1") {
    ...
    const zipName = Array.isArray(tbNames) ? "yuegongbao.zip" : tbNames + ".zip"
