...
.tree-sidebar {
  flex-shrink: 0;
  width: 220px;
  background: linear-gradient(180deg, rgba(13, 79, 136, 0.04), rgba(13, 79, 136, 0.01)), #ffffff;
  border: 1px solid var(--panel-border, #d6e0ea);
  ...
  box-shadow: var(--gov-shadow, 0 10px 28px rgba(10, 47, 85, 0.08));
...
.resize-handle {
  ...
  &:hover {
    background: rgba(13, 79, 136, 0.22);
  }

  &.active {
    background: rgba(13, 79, 136, 0.38);
  }
}
...
.collapse-button-container {
  ...
  box-shadow: 0 8px 18px rgba(9, 34, 61, 0.12);
...
.tree-header {
  ...
  padding: 0 14px;
  height: 46px;
  border-bottom: 1px solid var(--panel-border, #d6e0ea);
  background: linear-gradient(180deg, rgba(13, 79, 136, 0.06), rgba(13, 79, 136, 0.02));
  flex-shrink: 0;

  .tree-title {
    font-size: 13px;
    font-weight: 700;
    color: var(--content-text, #1c2b39);
    white-space: nowrap;
    overflow: hidden;
    display: flex;
    align-items: center;
...
.tree-action-icon {
  ...
  &:hover {
    color: var(--gov-primary, #0d4f88);
    background: var(--gov-primary-soft, #ebf3fb);
  }
}
...
.tree-wrap {
  ...
  :deep(.el-tree-node.is-current > .el-tree-node__content) {
    ...
    .node-icon {
      color: var(--gov-primary, #0d4f88) !important;
    }
  }
}
