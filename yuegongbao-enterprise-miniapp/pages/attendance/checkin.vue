<template>
  ...
  <view class="worker-page">
    ...
    <view v-if="pendingQueue.length" class="worker-card">
    ...
    <view v-if="syncHistory.length" class="worker-card">
      <view class="section-head">
...
import { checkIn, checkOut, getAttendanceMonthly, getTrainingProgress, uploadWorkerImage } from '../../api/enterprise-service'
