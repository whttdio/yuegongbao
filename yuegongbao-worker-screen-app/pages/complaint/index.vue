<template>
  <!-- ??????????????? /app/screen/** -->
  <view class="worker-page worker-page--screen-detail complaint-page">
...
import { createComplaint, createWorkerUploadRecord, getComplaintList, uploadWorkerImage } from '../../api/screen'
