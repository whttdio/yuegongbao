 ...
 */
@RestController
@RequestMapping("/ygb/salary/account")
public class YgbSalaryAccountController extends BaseController
{
    @Autowired
    ...
    @Log(title = "监管账户监控", businessType = BusinessType.EXPORT)
    ...
    public void export(HttpServletResponse response, YgbSalaryBatch salaryBatch)
    {
        ...
        util.exportExcel(response, list, "监管账户监控");
    }
}
